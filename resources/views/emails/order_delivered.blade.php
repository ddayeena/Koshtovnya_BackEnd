...
<body>
    <div class="container">
        ...
        <div class="message">
            Ваша посилка прибула до призначеного місця в {{$delivery->city}} | {{$delivery->delivery_address}}.
            Ми прагнемо надавати найкращий досвід у здійсненні покупок, тому надіємось на отримання відгуку від Вас!
        </div>
