...
<body>
    <div class="container">
        ...
        <div class="intro">
            <p>
                Вітаємо, {{ $user->first_name }}!<br>
                Ви просили повідомити, коли цей товар знову з’явиться у продажу.
                Сьогодні його вже можна придбати — заходьте на сайт та замовляйте.
            </p>
        </div>
